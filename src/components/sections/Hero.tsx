        ...
        <Container className="flex flex-col lg:flex-row gap:10 lg:gap-12">
            <div className="absolute w-full lg:w-1/2 inset-y-0 lg:right-0">
                <span className="absolute -left-6 md:left-4 top-24 lg:top-28 w-24 h-24 rotate-90 skew-x-12 rounded-3xl 
                                bg-gradient-to-r from-blue-600 to via-violet-600 blur-xl  opacity-60 lg:opacity-95
                                lg:block hidden">
            ...
            <div className="relative flex flex-col items-center text-center lg:text-left lg:py-8 lg:items-start
                ...
                from-blue-600 to via-violet-600 ml-2 ">with AI</span>
                </h1>
                ...
                <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0">
                    <div className="flex sm:flex-row flex-col gap-5 w-full">
                        <form action="#" className="py-1 pl-6 w-full pr-1 flex gap-3 items-center text-heading-3
                            ...
                            <input type="email" placeholder=" Enter your Email :" className="w-full py-4 outline-none
                                                             bg-transparent"/>
            ...
            {/* end of creating a news subscription form */}
