...
export const Card_Design= ({title, description, icon}:CardProps) =>{
    return <div className="p-5 sm:p-6 lg:p-8 rounded-3xl border border-box-border bg-box-bg shadow-lg
